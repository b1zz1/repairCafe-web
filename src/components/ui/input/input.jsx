        ...
        return (
            <div className={`relative ${sizeClasses[size]}`}>
                {leftIcon && (
                    <div
                        className={
                            'flex justify-center items-center absolute inset-y-0 left-1.5 h-full'
                        }
                    >
                        {leftIcon}
                    </div>
                ...
                {rightIcon && (
                    <div
                        className={
                            'flex items-center absolute inset-y-0 right-1.5 h-full'
                        }
                    >
                        {rightIcon}
                    </div>
